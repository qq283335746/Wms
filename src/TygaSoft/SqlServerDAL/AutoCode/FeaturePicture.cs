...
{
    public partial class FeaturePicture : IFeaturePicture
    {
        ...
        public int Insert(FeaturePictureInfo model)
        {
            ...
            sb.Append(@"insert into FeaturePicture (UserId,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,FunType,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        {
            StringBuilder sb = new StringBuilder(300);
            sb.Append(@"insert into FeaturePicture (Id,UserId,FileName,FileSize,FileExtension,FileDirectory,RandomFolder,FunType,LastUpdatedDate)
			            values
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Update(FeaturePictureInfo model)
        {
            ...
            sb.Append(@"update FeaturePicture set UserId = @UserId,FileName = @FileName,FileSize = @FileSize,FileExtension = @FileExtension,FileDirectory = @FileDirectory,RandomFolder = @RandomFolder,FunType = @FunType,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Delete(Guid id)
        {
            ...
            sb.Append("delete from FeaturePicture where Id = @Id ");
            SqlParameter[] parms = {
                                     new SqlParameter("@Id",SqlDbType.UniqueIdentifier)
                                   };
            parms[0].Value = id;
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from FeaturePicture where Id = @Id" + n + " ;");
        ...
        {
            StringBuilder sb = new StringBuilder(500);
            sb.Append(@"select count(*) from FeaturePicture ");
            if (!string.IsNullOrEmpty(sqlWhere)) sb.AppendFormat(" where 1=1 {0} ", sqlWhere);
            totalRecords = (int)SqlHelper.ExecuteScalar(SqlHelper.WmsDbConnString, CommandType.Text, sb.ToString(), cmdParms);

            if (totalRecords == 0) return new List<FeaturePictureInfo>();
            ...
            IList<FeaturePictureInfo> list = new List<FeaturePictureInfo>();
            ...
            using (SqlDataReader reader = SqlHelper.ExecuteReader(SqlHelper.WmsDbConnString, CommandType.Text, sb.ToString(), cmdParms))
            {
                if (reader != null && reader.HasRows)
                {
                    while (reader.Read())
                    {
                        FeaturePictureInfo model = new FeaturePictureInfo();
