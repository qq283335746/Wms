<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCustomer.aspx.cs" Inherits="TygaSoft.Web.Manages.Gzxy.AddCustomer" %>
...
<body>
    <form id="dlgCustomerFm" runat="server">
        <div class="row-fl">
            <span class="rl">客户编号：</span>
            <div class="fl">
                <input id="txtCoded" class="txt200" />
            </div>
        </div>
        <div class="row-fl">
            <span class="rl"><span class="cr">*</span>客户全称：</span>
            <div class="fl">
                <input id="txtNamed" class="easyui-validatebox txt200" data-options="required:true" />
            </div>
        </div>
        <div class="row-fl">
            <span class="rl"><span class="cr">*</span>客户简称：</span>
            <div class="fl">
    ...
    <script type="text/javascript" src="/wms/Scripts/Manages/Gzxy/AddCustomer.js"></script>
