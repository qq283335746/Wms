...
namespace TygaSoft.SqlServerDAL
{
    public partial class MesProduct : IMesProduct
    {
        ...
        public int Insert(MesProductInfo model)
        {
            ...
            sb.Append(@"insert into MesProduct (UserId,CategoryId,Coded,Named,UseQty,Barcode,Sort,Remark,LastUpdatedDate)
			            values
						(@UserId,@CategoryId,@Coded,@Named,@UseQty,@Barcode,@Sort,@Remark,@LastUpdatedDate)
			            ");
...
new SqlParameter("@UseQty",SqlDbType.Float),
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
            ...
            parms[4].Value = model.UseQty;
            parms[5].Value = model.Barcode;
        ...
        {
            StringBuilder sb = new StringBuilder(300);
            sb.Append(@"insert into MesProduct (Id,UserId,CategoryId,Coded,Named,UseQty,Barcode,Sort,Remark,LastUpdatedDate)
			            values
						(@Id,@UserId,@CategoryId,@Coded,@Named,@UseQty,@Barcode,@Sort,@Remark,@LastUpdatedDate)
			            ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Update(MesProductInfo model)
        {
            ...
            sb.Append(@"update MesProduct set UserId = @UserId,CategoryId = @CategoryId,Coded = @Coded,Named = @Named,UseQty = @UseQty,Barcode = @Barcode,Sort = @Sort,Remark = @Remark,LastUpdatedDate = @LastUpdatedDate 
			            where Id = @Id
					    ");
...
new SqlParameter("@LastUpdatedDate",SqlDbType.DateTime)
        ...
        public int Delete(Guid id)
        {
            ...
            sb.Append("delete from MesProduct where Id = @Id ");
            SqlParameter[] parms = {
                                     new SqlParameter("@Id",SqlDbType.UniqueIdentifier)
                                   };
            parms[0].Value = id;
        ...
        public bool DeleteBatch(IList<object> list)
        {
            ...
            {
                n++;
                sb.Append(@"delete from MesProduct where Id = @Id" + n + " ;");
        ...
        {
            MesProductInfo model = null;

            StringBuilder sb = new StringBuilder(300);
            sb.Append(@"select top 1 Id,UserId,CategoryId,Coded,Named,UseQty,Barcode,Sort,Remark,LastUpdatedDate 
			            from MesProduct
						where Id = @Id ");
            SqlParameter[] parms = {
                                     new SqlParameter("@Id",SqlDbType.UniqueIdentifier)
        ...
        {
            StringBuilder sb = new StringBuilder(500);
            sb.Append(@"select count(*) from MesProduct ");
            if (!string.IsNullOrEmpty(sqlWhere)) sb.AppendFormat(" where 1=1 {0} ", sqlWhere);
            totalRecords = (int)SqlHelper.ExecuteScalar(SqlHelper.WmsDbConnString, CommandType.Text, sb.ToString(), cmdParms);

            if (totalRecords == 0) return new List<MesProductInfo>();
            ...
            IList<MesProductInfo> list = new List<MesProductInfo>();
        ...
        {
            StringBuilder sb = new StringBuilder(500);
            sb.Append(@"select Id,UserId,CategoryId,Coded,Named,UseQty,Barcode,Sort,Remark,LastUpdatedDate
                        from MesProduct ");
            if (!string.IsNullOrEmpty(sqlWhere)) sb.AppendFormat(" where 1=1 {0} ", sqlWhere);
