<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAddOrderReceipt.ascx.cs" Inherits="TygaSoft.Web.WebUserControls.UCAddOrderReceipt" %>
<table class="infoT">
    <tr>
        ...
        <td><div class="tar">ASN预收货单：</div></td>
        <td>
            <input id="cbgPreOrderCode" class="easyui-combogrid txt" data-options="validType:'orderCode',mode:'remote',idField:'Id',textField:'Name',editable:false" style="width:120px" />
        </td>
        <td><div class="tar">订单号：</div></td>
        <td>
            <input id="txtPurchaseOrderCode" class="easyui-validatebox txt" data-options="validType:'orderCode'" style="width:120px" />
        </td>
    </tr>
    <tr>
